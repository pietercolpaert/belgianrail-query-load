...
q1="$q0 query-mixes/round1.jsonstream"
...
## Launch Experiment 0
sort -n -t: -k2 $q0 | ./bin/runner.js -c $lc > results/experiment0-lc.csv &
pidstat -p $1 1 900 | grep Average >> benchmarkcpu.log;
sleep 10;
sort -n -t: -k2 $q0 | ./bin/runner.js -c $qs > results/experiment0-queryserver.csv &
pidstat -p $1 1 900 | grep Average >> benchmarkcpu.log;
sleep 10;
sort -n -t: -k2 $q0 | ./bin/runner.js -c $lcnc > results/experiment0-lcnc.csv &
pidstat -p $2 1 900 | grep Average >> benchmarkcpu.log;
sleep 10;
...
## Launch Experiment 3
sort -n -t: -k2 $q3 | ./bin/runner.js -c $lc > results/experiment3-lc.csv&
pidstat -p $1 1 900 | grep Average >> benchmarkcpu.log;
sleep 10;
sort -n -t: -k2 $q3 | ./bin/runner.js -c $qs > results/experiment3-queryserver.csv &
pidstat -p $1 1 900 | grep Average >> benchmarkcpu.log;
sleep 10;
...
## Launch Experiment 5
sort -n -t: -k2 $q5 | ./bin/runner.js -c $lc > results/experiment5-lc.csv&
pidstat -p $1 1 900 | grep Average >> benchmarkcpu.log;
sleep 10;
sort -n -t: -k2 $q5 | ./bin/runner.js -c $qs > results/experiment5-queryserver.csv &
pidstat -p $1 1 900 | grep Average >> benchmarkcpu.log;
sleep 10;
